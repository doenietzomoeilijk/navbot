...
namespace EveMarketTool
{
    ...
    public class Constants
    {
        ...
        public readonly static bool IsBetaVersion = true;
        ...
        public readonly static string Revision = "M (Beta)";
        public readonly static string Credits = 
            ...
            "jlstrobel (John Strobel), rigbyd, Terracarbon (Terry Winfrey), Papa Yoru (Tony Jackson), Mikal Red and others.";
    }
}
